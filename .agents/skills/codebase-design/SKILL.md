...
Selected when a task designs or improves a module's interface, finds deepening
opportunities, decides where a seam goes, or makes code more testable and
navigable; other capabilities ([../tdd/](../tdd/SKILL.md),
[../improve-codebase-architecture/](../improve-codebase-architecture/SKILL.md))
reference it for this vocabulary.

This is design vocabulary and procedure, not architecture authority. If its
advice conflicts with accepted project architecture or an ADR, the accepted
project truth wins. The aim is leverage for callers, locality for maintainers,
...
- **Exploring alternative interfaces**, see
  ...
  radically different ways in independent passes, then compare on depth,
